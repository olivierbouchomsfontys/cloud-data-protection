...
const AccountSettings = () => {
    ...
    return (
        <div className='account-settings'>
            <div className='account-settings__section account-settings__userinfo'>
                ...
                <Button className='account-settings__section__btn' variant='contained' color='secondary' onClick={onChangeEmailClick} disabled={loading}>
            ...
            <div className='account-settings__section account-settings__userinfo'>
                ...
                <Button className='account-settings__section__btn' variant='contained' color='secondary' onClick={onChangePasswordClick} disabled={loading}>
                    Change my password
                </Button>
