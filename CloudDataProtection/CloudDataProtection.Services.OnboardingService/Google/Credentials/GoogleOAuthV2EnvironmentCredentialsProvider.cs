...
namespace CloudDataProtection.Services.Onboarding.Google.Credentials
{
    ...
    {
        private static readonly string ClientIdEnvironmentKey = "CDP_DEV_ONBOARDING_GOOGLE_OAUTH2_CLIENT_ID";
        private static readonly string ClientSecretEnvironmentKey = "CDP_DEV_ONBOARDING_GOOGLE_OAUTH2_CLIENT_SECRET";
